 ...
 */
public class WriteAnnouncementActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.choose_class:
                Intent intent = new Intent(mContext, MyClassListActivity.class);
    ...
    private void send() {
        ...
        new NewsRequest(mContext,handler).send_annocunce(homework_title.getText().toString(), homework_content.getText().toString(),studentids,pushImgName,genre,ADD_KEY);

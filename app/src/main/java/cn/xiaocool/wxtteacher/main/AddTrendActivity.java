...
public class AddTrendActivity extends BaseActivity implements View.OnClickListener {
                    ...
                    if (msg.obj != null) {
                        ...
                        if (obj.optString("status").equals(CommunalInterfaces._STATE)) {
                            ...
                            if (imgFlag < filepaths.size()) {
                                ...
                                new NewsRequest(mContext, handler).send_trend(homework_content.getText().toString(), pushImgName, "1", ADD_KEY);
                            }
                        } else {
                            hud.dismiss();
        ...
        switch (v.getId()) {
            ...
            case R.id.homework_send:
                ...
                if (homework_content.getText().length() < 1) {
                    ToastUtils.ToastShort(AddTrendActivity.this, "发送内容不能为空");
                } else {
                    if (NetUtil.isConnnected(this)) {
                        ...
                        ToastUtils.ToastShort(AddTrendActivity.this, "网络请求失败");
                    }
                }
    ...
    private void showActionSheet() {
        ...
        CoreConfig coreConfig = new CoreConfig.Builder(AddTrendActivity.this, imageLoader, theme)
                .setFunctionConfig(functionConfig)
                .setPauseOnScrollListener(pauseOnScrollListener)
                .setNoAnimcation(true)
                .build();
        GalleryFinal.init(coreConfig);
        ActionSheet.createBuilder(AddTrendActivity.this, getSupportFragmentManager())
    ...
    private GalleryFinal.OnHanlderResultCallback mOnHanlderResultCallback = new GalleryFinal.OnHanlderResultCallback() {
        ...
        public void onHanlderFailure(int requestCode, String errorMsg) {
            Toast.makeText(AddTrendActivity.this, errorMsg, Toast.LENGTH_SHORT).show();
        }
    };

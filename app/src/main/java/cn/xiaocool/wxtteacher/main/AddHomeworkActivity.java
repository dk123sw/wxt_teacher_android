...
public class AddHomeworkActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        //添加图片按钮
        localImgGridAdapter = new LocalImgGridAdapter(mPhotoList, AddHomeworkActivity.this,handler);
        homework_pic_grid.setAdapter(localImgGridAdapter);
                        ...
                        if (NetUtil.isConnnected(this)) {
                            if (filepaths.size() > 0) {
                                ...
                                hud = KProgressHUD.create(this)
                                        ...
                                        .setCancellable(true);
                                hud.show();
                                new NewsRequest(AddHomeworkActivity.this,handler).send_homework(homework_title.getText().toString(), homework_content.getText().toString(),studentids,pushImgName,subject,ADD_KEY);

 ...
 */
public class ReciveReadOrNotReadAdapter extends BaseAdapter {

    private ArrayList<NewsGroupRecive.DataBean.ReceiverBean> classListDataList;
    private LayoutInflater inflater;
    private Context mContext;
    private String type;
    private DisplayImageOptions displayImageOptions;
    public ReciveReadOrNotReadAdapter(ArrayList<NewsGroupRecive.DataBean.ReceiverBean> classListDataList, Context context, String type) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final NewsGroupRecive.DataBean.ReceiverBean data = classListDataList.get(position);
        ...
        holder.name.setText(data.getReceiver_user_name());
        holder.sms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mContext, TeacherCommunicationActivity.class);
                intent.putExtra("reciver_id", data.getReceiver_user_id());
                intent.putExtra("chat_name", data.getReceiver_user_name());
